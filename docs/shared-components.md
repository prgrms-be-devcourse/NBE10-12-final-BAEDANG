...
- `StockRepository.findQuoteTargets/isQuoteTarget` selects ACTIVE ∩ (ranked ∪ unexpired LIMIT PENDING/PARTIALLY_FILLED with remaining quantity > 0), across all users. Publication rechecks membership. Index additions are deferred to the execution-worker work.

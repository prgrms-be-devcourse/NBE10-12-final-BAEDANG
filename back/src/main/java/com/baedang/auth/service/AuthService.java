...
public class AuthService {
    ...
    public UserResponse signUp(SignUpRequest request) {
        ...
        Account account = accountRepository.save(Account.open(user.getUserId(), 1, initialCash, openedAt));
        initialDepositLedgerService.recordInitialDeposit(
                account.getAccountId(), account.getInitialCash(), account.getRoundNo(), account.getOpenedAt());

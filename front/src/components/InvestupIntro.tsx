          ...
          >
            ...
            <a
              ...
              style={{
                ...
                minHeight: 54,
                padding: '0 44px',
                // 첨부 사진(토스 스타일 알약형 버튼) 참고로 시작해 회색·반투명
                // 배경을 거쳐왔는데, 다시 흰색 기반으로 바꾸되 은근히 투명하게,
                // 그리고 오른쪽으로 갈수록 더 옅어지도록(왼쪽 35% → 오른쪽 0%)
                // 그라데이션으로 바꿨다. 남색 대신 짙은 무채색 글자, 무거운
                // 그림자 대신 아주 옅은 그림자는 그대로 뒀다.
                borderRadius: 999,
                background: 'linear-gradient(90deg, rgba(255,255,255,.35) 0%, rgba(255,255,255,0) 100%)',
                color: '#191f28',

...
const STOCK_DETAIL_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: "차트 크게 보기",
    description:
      "이 버튼을 누르면 차트를 더 크게 확대해서 볼 수 있어요.\n작은 캔들 하나하나의 움직임이나 특정 구간의 흐름을 더 꼼꼼히 살펴보기 좋아요.\n확대 화면에서도 일봉·1분봉, 기간은 그대로 바꿀 수 있어요.\n한번 눌러보세요.",
  },
  {
  ...
  },
  {
    ...
    title: "매수 · 매도 체험하기",
    description:
      "이 버튼을 누르면 실제로 모의 주문이 즉시 체결돼요.\n가상의 돈으로 하는 연습이니 걱정 말고 눌러서 체험해보세요!\n다음에 또 안내가 필요하시면 상단의 '화면 가이드' 버튼을 눌러주세요.",
  },
];

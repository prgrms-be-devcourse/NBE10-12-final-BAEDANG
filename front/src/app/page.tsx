          ...
          {STEPS.map((s) => (
            <TiltCard
              ...
              style={{
                ...
                // 단계 낮췄다(라이트 모드 값은 그대로 유지). 이후 "아주 조금만 더
                // 진하게" 요청을 받아 라이트/다크 모두 불투명도만 살짝 더 올렸다.
                background:
                  theme === "dark"
                    ? "radial-gradient(120% 120% at 50% 50%, rgba(45,95,155,0.72) 0%, rgba(45,95,155,0.34) 45%, var(--card) 100%)"
                    : "radial-gradient(120% 120% at 50% 50%, rgba(196,222,248,0.92) 0%, rgba(196,222,248,0.48) 45%, #ffffff 100%)",
              }}
            >
              <span

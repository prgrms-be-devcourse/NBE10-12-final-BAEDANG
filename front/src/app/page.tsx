          ...
          {STEPS.map((s) => (
            <TiltCard
              ...
              style={{
                ...
                // 단계 낮췄다(라이트 모드 값은 그대로 유지). 이후 두 차례에 걸쳐
                // "더 진하게" 요청을 받아 라이트/다크 모두 불투명도를 더 올렸다 —
                // 처음엔 살짝만 올렸는데 여전히 옅다는 피드백을 받아 이번엔 눈에
                // 띄게 크게 올렸다.
                background:
                  theme === "dark"
                    ? "radial-gradient(120% 120% at 50% 50%, rgba(45,95,155,0.88) 0%, rgba(45,95,155,0.5) 45%, var(--card) 100%)"
                    : "radial-gradient(120% 120% at 50% 50%, rgba(196,222,248,1) 0%, rgba(196,222,248,0.68) 45%, #ffffff 100%)",
              }}
            >
              <span

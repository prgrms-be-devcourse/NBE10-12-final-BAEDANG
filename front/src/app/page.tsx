        ...
        <div className="flex gap-4 max-md:flex-col">
          {STEPS.map((s) => (
            <TiltCard
              ...
              // 가장 진하고 바깥으로 갈수록 옅어지는 radial gradient. 이전 버전은
              // 원(150% 150%)이 카드보다 훨씬 커서 카드 안에서는 가장자리까지도
              // 색이 거의 안 빠지고 밋밋하게 보였다 — 원 크기를 카드에 맞게
              // 줄이고(120% 120%) 중심부 농도도 올려, 중앙은 또렷하고 모서리는
              // 페이지 배경(--bg)에 거의 녹아들 만큼 확실하게 옅어지도록 했다.
              style={{
                background:
                  theme === "dark"
                    ? "radial-gradient(120% 120% at 50% 50%, rgba(58,122,189,0.65) 0%, rgba(58,122,189,0.28) 45%, rgba(58,122,189,0) 100%)"
                    : "radial-gradient(120% 120% at 50% 50%, rgba(168,208,240,0.85) 0%, rgba(168,208,240,0.4) 45%, rgba(168,208,240,0) 100%)",
              }}
            >
              <span
